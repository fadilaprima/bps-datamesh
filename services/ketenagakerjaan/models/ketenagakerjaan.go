...
type RekamKetenagakerjaan struct {
	...
	StatusPekerjaanUtama                       string    `gorm:"column:status_dalam_pekerjaan_utama" json:"status_dalam_pekerjaan_utama" parquet:"name=status_dalam_pekerjaan_utama, type=UTF8"`
	...
	LapanganUsahaUsahaUtama                    string    `gorm:"column:lapangan_usaha_dari_usaha_utama" json:"lapangan_usaha_dari_usaha_utama" parquet:"name=lapangan_usaha_dari_usaha_utama, type=UTF8"`
